...
public class AdminAuthService : IAdminAuthService
{
    ...
    private readonly IAdminstratorRepository _adminRepository;
    ...
    public AdminAuthService(ITokenService tokenService,
        IAdminstratorRepository administratorRepository,
    ...
    public async Task<(bool Result, string Token)> LoginAsync(LoginDto loginDto)
    {
        ...
        if (admin is null) throw new AdminstratorNotFoundException();
